---
name: file-writer
description: Write or update files in the repository safely, with path-traversal and .env write protection. Use whenever a pipeline agent needs to write docs/, src/, or CHANGELOG.md content to disk.
---
...
## Used By
- `requirements-subagent`, `planner-subagent`, `design-subagent`,
